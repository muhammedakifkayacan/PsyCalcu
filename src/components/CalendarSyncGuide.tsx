        ...
        <div className="relative bg-emerald-50/40 border border-emerald-100/80 p-6 rounded-2xl text-emerald-900 space-y-3 shadow-xs animate-fade-in pr-12">
          ...
          <div className="bg-white/95 p-4 rounded-xl border border-emerald-200/50 space-y-2 text-xs">
            ...
            <ul className="list-disc pl-5 space-y-1 text-slate-600">
              ...
              <li><strong className="font-semibold text-slate-800">Otomatik Kişisel Etkinlik Filtresi:</strong> Takviminizdeki spor, alışveriş, kuaför, doktor, diş randevusu, tatil, yemek veya toplantı gibi seans dışı planlar otomatik tespit edilerek <strong>"Seans Değil"</strong> olarak kaydedilir; seans sayınıza, cironuza veya ofis/bakıcı giderlerinize dahil edilmez.</li>
